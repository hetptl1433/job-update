...
const seed = [
  ...
  {id:1014,company:'Shane Smith Law',role:'AI Specialist (Internship)',stage:'Hiring Manager Interview',inviteDate:'2026-07-23',interviewDate:'2026-07-27',status:'Interview Scheduled',priority:'High',nextAction:'Prepare for the Zoom interview on July 27 at 9:30 AM Eastern.',followUpDate:'2026-07-27',contact:'Shane Smith Law recruiting',mode:'Zoom',source:'',notes:'Zoom interview confirmed for July 27 at 9:30 AM Eastern with company leadership.'},
  ...
  {id:1016,company:'Mercor',role:'Computer Vision Expert',stage:'Final Decision',inviteDate:'',interviewDate:'',status:'Rejected',priority:'Low',nextAction:'Closed.',followUpDate:'',contact:'Mercor recruiting',mode:'Email',source:'',notes:"Hiring manager did not advance the application due to project constraints; profile remains in Mercor's candidate pool."},
  {id:1017,company:'Mercor',role:'Machine Learning & NLP Expert',stage:'Final Decision',inviteDate:'',interviewDate:'',status:'Rejected',priority:'Low',nextAction:'Closed.',followUpDate:'',contact:'Mercor recruiting',mode:'Email',source:'',notes:"Hiring manager did not advance the application due to project constraints; profile remains in Mercor's candidate pool."},
  {id:1018,company:'Renesas Electronics',role:'AI Research Engineer Intern',stage:'Final Decision',inviteDate:'',interviewDate:'',status:'Rejected',priority:'Low',nextAction:'Closed.',followUpDate:'',contact:'Renesas recruiting',mode:'Email',source:'',notes:'Renesas confirmed on July 27 that the application would not advance because other candidates were a closer immediate match.'}
];
